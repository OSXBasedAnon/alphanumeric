...
export ALPHANUMERIC_STATS_BIND="${ALPHANUMERIC_STATS_BIND:-0.0.0.0}"
...
export ALPHANUMERIC_DISABLE_PUBLIC_ANNOUNCE="${ALPHANUMERIC_DISABLE_PUBLIC_ANNOUNCE:-false}"
export ALPHANUMERIC_ENABLE_HEADER_SNAPSHOTS="${ALPHANUMERIC_ENABLE_HEADER_SNAPSHOTS:-true}"
export ALPHANUMERIC_ENABLE_STATS_SNAPSHOTS="${ALPHANUMERIC_ENABLE_STATS_SNAPSHOTS:-true}"
