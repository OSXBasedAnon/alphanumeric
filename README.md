...
| [`docs/GPU_MINING.md`](docs/GPU_MINING.md) | GPU mining setup and tuning. This branch carries the GPU backend |
...
- `mine [wallet_name] [--continuous|-c] [--gpu|--cpu]` (bare: rewards go to your default
  ...
  CPU and refuses `--gpu`. See [`docs/GPU_MINING.md`](docs/GPU_MINING.md)
- `info`
- `debug`
